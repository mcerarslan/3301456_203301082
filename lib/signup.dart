...
class _SignUpState extends State<SignUp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back,color: Color(0xFFa023f1)),
          onPressed: () {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: <Widget> [
                    SizedBox(
                      height: 180,
                      child: Image.asset("assets/images/mce.png",fit: BoxFit.contain,),
  ...
  postDetailsToFirestore() async{
   ...
   userModel.ad = AdEditingController.text;
   userModel.soyAd = SoyadEditingController.text;
